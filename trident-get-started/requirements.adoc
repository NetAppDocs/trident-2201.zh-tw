...
* Kubernetes 1.17或更新版本（最新版本：1.23）
...
* k8s.gcr.io/sig-storage / csi節點驅動程式登錄程式：v2.4
* NetApp/Trident營運者：22.01.1（選用）
...
* NetApp/Trident：22.01.1
* NetApp/Trident自動支援：22.01
* k8s.gcr.io/sig-storage / csi佈建程式：v3.1.0
* k8s.gcr.io/sig-storage / csi附加程式：v3.4.0
* k8s.gcr.io/sig-storage / csi大小調整程式：v1.3.0
* k8s.gcr.io/sig-storage / csi快照記錄：v3.0.3
* k8s.gcr.io/sig-storage / csi節點驅動程式登錄程式：v2.4
